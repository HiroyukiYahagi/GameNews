...
SWIFT_CLASS_NAMED("GridCollectionViewLayout")
...
@property (nonatomic) CGFloat itemHeightRatio;
...
@interface BSGridCollectionViewLayout (SWIFT_EXTENSION(BSGridCollectionViewLayout))
@end
